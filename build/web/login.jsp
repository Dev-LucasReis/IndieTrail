        ...
        <script>
            const app = Vue.createApp({
                ...
                methods: {
                    ...
                    async loadList() {
                        const data = await this.request("/indieTrail/api/parking", "GET");
                        if(data) {
                    ...
                    async addStay() {
                        const data = await this.request("/indieTrail/api/parking", "POST", {plate: this.newPlate, model: this.newModel, color: this.newColor});
                        if(data) {
                            this.newPlate = ''; 
                            this.newModel = ''; 
                            this.newColor = '';
                    ...
                    async finishStay(rowId) {
                        const data = await this.request("/indieTrail/api/parking", "PUT", {id: rowId});
                        if(data) {
                            await this.loadList();
                        }
                    },
